...
import { SubcategoryService } from "../../services/MarketPlace";
...
class SubcategoryController {
  static findMany(request: any, response: Response) {
    ...
    SubcategoryService.findMany(parsedQuery.query, parsedQuery.paranoid)
      .then((result) => {
  ...
  static findOne(request: any, response: Response) {
    ...
    SubcategoryService.findOne(parsedQuery.query, parsedQuery.paranoid)
      .then((result) => {
        ServerResponse(request, response, 200, result, "", startTime);
      })
      .catch((error) => {
  ...
  static create(request: any, response: Response) {
    ...
    if (!error) {
      ...
      SubcategoryService.create(user, data)
        .then((result) => {
  ...
  static update(request: any, response: Response) {
    ...
    if (!error) {
      ...
      const data: any = request.body;
      const user: User = request.user;
      SubcategoryService.update(user, id, data)
        .then((result) => {
  ...
  static delete(request: any, response: Response) {
    ...
    if (!error) {
      ...
      const user: User = request.user;
      SubcategoryService.delete(user, id, null, force)
        .then((result) => {
          ServerResponse(request, response, 200, result, "Success", startTime);
        })
        .catch((error) => {
  ...
  static restore(request: any, response: Response) {
    ...
    if (!error) {
      const id: string = request.body.id;
      const user: User = request.user;
      SubcategoryService.restore(user, id)
        .then((result) => {
          ServerResponse(request, response, 200, result, "Success", startTime);
        })
        .catch((error) => {
