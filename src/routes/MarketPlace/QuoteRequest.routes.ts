...
const routes = () => {
  ...
  router.get(
    "/get",
    AuthenticateUser,
    QuoteRequestController.findOne
  );

  router.get(
    "/profile",
    AuthenticateUser,
    QuoteRequestController.findMyProfile
  );
  ...
  router.get(
    "/:id",
    AuthenticateUser,
    QuoteRequestController.findById
  );
  ...
  router.get(
    "/",
    AuthenticateUser,
    QuoteRequestController.findMany
  );
  ...
  router.patch(
    "/restore",
    AuthenticateUser,
    QuoteRequestController.restore
  );
