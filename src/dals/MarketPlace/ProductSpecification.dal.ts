...
import { ProductSpecification as BaseModel } from "../../models/MarketPlace";
import BaseDAL from "../Base.dal";

class ProductSpecificationDAL {
  /**
   *
   *
   * @static
   ...
   * @param {Transaction} t
   * @memberof ProductSpecificationDAL
   */
  static create = (
...
export default ProductSpecificationDAL;
