...
import { NewsletterSubscription as BaseModel } from "../../models/MarketPlace";
import BaseDAL from "../Base.dal";

class NewsletterSubscriptionDAL {
  /**
   *
   *
   * @static
   ...
   * @param {Transaction} t
   * @memberof NewsletterSubscriptionDAL
   */
  static create = (
...
export default NewsletterSubscriptionDAL;
