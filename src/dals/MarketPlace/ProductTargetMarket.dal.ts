...
import { ProductTargetMarket as BaseModel } from "../../models/MarketPlace";
import BaseDAL from "../Base.dal";

class ProductTargetMarketDAL {
  /**
   *
   *
   * @static
   ...
   * @param {Transaction} t
   * @memberof ProductTargetMarketDAL
   */
  static create = (
...
export default ProductTargetMarketDAL;
