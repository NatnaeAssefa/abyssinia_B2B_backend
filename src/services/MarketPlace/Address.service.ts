...
import { Address } from "../../models/MarketPlace";
...
class AddressService {
  ...
  static findMany = (
    ...
    return new Promise((resolve, reject) => {
      AddressDAL.findMany(options, paranoid)
        .then((result) => {
          resolve(result);
        })
        .catch((error) => {
  ...
  static findById = (
    ...
    return new Promise((resolve, reject) => {
      AddressDAL.findById(id, options, paranoid)
        .then((result) => {
          resolve(result);
        })
        .catch((error) => reject(new InternalServerError(error)));
    ...
    return new Promise((resolve, reject) => {
      async.waterfall(
        [
          ...
          (transaction: Transaction, done: Function) => {
            AddressDAL.findById(id, options, true)
              .then((Address) => {
                if (Address) {
                  done(null, transaction, Address);
                } else {
          ...
          (transaction: Transaction, Address: Address, done: Function) => {
            AddressDAL.restore({ id: Address.id }, transaction)
              .then((result) => {
                done(null, Address, { obj: result, transaction: transaction });
              })
              .catch((error) =>
